...
#SBATCH -p CPU-192C768GB --qos=qos_cpu_192c768gb -n 101
...
mpiexec -n $SLURM_NTASKS python -m mpi4py.futures figS1.py --depolarizing_noise
mpiexec -n $SLURM_NTASKS python -m mpi4py.futures figS1.py --measurement